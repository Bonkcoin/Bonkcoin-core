 ...
 *
 *  Boncoin:    Increment mempool limits and accept RBF in steps of 0.0001 BONC
...
/**
 * Boncoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Boncoin: Default hard dust limit that is evaluated when considering whether
