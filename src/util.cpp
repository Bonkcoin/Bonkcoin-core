...
const char * const BITCOIN_CONF_FILENAME = "boncoin.conf";
const char * const BITCOIN_PID_FILENAME = "boncoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Boncoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Boncoin";
#else
    // Unix
    return pathRet / ".boncoin";
#endif
#endif
}
