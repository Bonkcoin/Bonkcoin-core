...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Boncoin Core repository on GitHub"),
        tr("Services that claim to double your boncoins are always ponzi schemes")
    };
