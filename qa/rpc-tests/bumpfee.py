...
class BumpFeeTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        test_boncoin_wallet_minchange(rbf_node, dest_address)
...
def test_settxfee(rbf_node, dest_address):
    # Boncoin: Increment is fixed, so this test tests for settxfee not making a difference
...
def test_boncoin_wallet_minchange(rbf_node, dest_address):
